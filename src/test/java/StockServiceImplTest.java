...
public class StockServiceImplTest {
	 ...
	 @Autowired
	    ...
	    public void testretrieveAllStocks(){
	       int listStock = ss.retrieveAllStocks().size();
	        List<Stock> listStocks = ss.retrieveAllStocks();
	        Assertions.assertEquals(listStock,listStocks.size());
	    }
	    ...
	    @Order(3)
	     public void testretrieveStock(){
	    	Stock s = ss.addStock(Stock.builder()
	               ...
	               .qteMin(7)
	               .build());
	        Assertions.assertEquals(s.getIdStock(), ss.retrieveStock(s.getIdStock()).getIdStock()) ;
	    ...
	    public void tesupdateOperateur(){
	    	Stock s = ss.addStock(Stock.builder()
		               ...
		               .qteMin(15)
		               .build());
	    	s.setLibelleStock("Libelle Stock Updated");
	        ss.updateStock(s);
	        Assertions.assertEquals("Libelle Stock Updated", ss.updateStock(s).getIdStock());
